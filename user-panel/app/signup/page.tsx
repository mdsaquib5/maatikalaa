        ...
        <main className="auth-page" style={{ 
            ...
            <div className="auth-container" style={{ maxWidth: '480px', width: '100%', position: 'relative', zIndex: 2 }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                    ...
                    <h1 style={{ fontSize: '2.5rem', fontWeight: 700, color: 'var(--color-text-heading)', letterSpacing: '-1px' }}>Create Account</h1>
                    <p style={{ color: 'var(--color-text-body)', fontSize: '1rem', marginTop: '8px' }}>Join our community of handcrafted art lovers.</p>
                </div>
                ...
                <div style={{ 
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
                        <div className="form-group" style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            <label style={{ color: 'var(--color-text-heading)', fontSize: '0.85rem', fontWeight: 600, letterSpacing: '0.5px' }}>FULL NAME</label>
                    ...
                    <div style={{ textAlign: 'center', marginTop: '32px', paddingTop: '32px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                        <p style={{ color: 'var(--color-text-body)', fontSize: '0.95rem' }}>
                            Already have an account? <Link href="/login" style={{ color: 'var(--color-accent-primary)', fontWeight: 600, textDecoration: 'none' }}>Sign In</Link>
                        </p>
                    </div>
                </div>
            </div>
